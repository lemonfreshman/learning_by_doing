...
seconds_in_a_year = seconds_in_a_week * average_weeks_in_a_year
...
puts "That means when you turn 20, you've been alive for #{20 *
    seconds_in_a_year.to_i} seconds,
and if you make it to 100, you will have lived #{100 * seconds_in_a_year.to_i} seconds. Make them count!"
